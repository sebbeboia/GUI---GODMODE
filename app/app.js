(() => {
  ...
  var TITLES = {
    command: ["COMMAND CENTER", "operational overview \xB7 real-time"],
  ...
  var Pwnboard = class extends React.Component {
    ...
    _seed() {
      const boot = [
        ...
        "[*] mounting quantized ollama \xB7 llama3-pentest-q4 \u2026 ok",
        "[*] tor circuit established \xB7 3 hops \xB7 exit DE",
    ...
    _afterComplete(j) {
      ...
      setTimeout(() => {
        ...
        this._pushActivity(`${j.tool} completed \xB7 ${n} findings`, j.color);
    ...
    _osintRows(tool, q) {
      const M = {
        ...
        ipcam: [
          ...
          ["port 554/rtsp", "stream open \xB7 no auth", "critical"],
          ["firmware", "V5.4.5 \u2014 CVE-2021-36260", "critical"],
          ["geo", "52.52, 13.40", "info"],
          ["snapshot", "/onvif/snapshot reachable", "high"]
        ],
        username: [
          ["github", "sebbeboia \xB7 42 repos", "info"],
          ["reddit", "u/" + q + " \xB7 3y old", "low"],
          ["reuse", "same handle \xB7 6 platforms", "medium"],
        ...
        geo: [
          ...
          ["country", "US \xB7 Mountain View", "info"],
    ...
    onCmdKey(e) {
      ...
      if (c === "tools") {
        this._pushTerm("[+] 12 kali \xB7 8 osint \xB7 5 ai modules online");
        return;
      }
      if (parts[0] === "scan") {
      ...
      if (parts[0] === "ai") {
        this._pushTerm(["[*] ollama \xB7 thinking\u2026", "[+] suggestion: try CVE-2021-36260 against the rtsp endpoint"]);
        return;
      }
    ...
    renderHeader(threat) {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, letterSpacing: 2, color: "#c8d6e4" } }, title), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, letterSpacing: 1, color: "#4a6a8a", marginTop: 2 } }, sub)),
